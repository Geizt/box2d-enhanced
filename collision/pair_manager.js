...
(function() {
  ...
  box2d.PairManager = (function() {
    ...
    function PairManager(broadPhase, callback) {
      var index, pair, _i, _j, _k, _ref, _ref1, _ref2;
      this.freePair = 0;
      this.pairCount = 0;
      this.pairBufferCount = 0;
      if ((broadPhase != null) && typeof broadPhase === 'object' && (callback != null) && typeof callback === 'function') {
        ...
        this.callback = null;
        this.hashTable = [];
        for (index = _i = 0, _ref = box2d.Settings.maxPairs - 1; _i <= _ref; index = _i += 1) {
          this.hashTable.push(box2d.Settings.USHRT_MAX);
        }
        this.pairs = [];
        for (index = _j = 0, _ref1 = box2d.Settings.maxPairs - 1; _j <= _ref1; index = _j += 1) {
          pair = new box2d.Pair();
        ...
        this.pairs[box2d.Settings.maxPairs - 1].next = box2d.Settings.USHRT_MAX;
        this.pairBuffer = [];
        for (index = _k = 0, _ref2 = box2d.Settings.maxPairs - 1; _k <= _ref2; index = _k += 1) {
          this.pairBuffer.push(new box2d.BufferedPair());
        }
      }
    }
